...
public class BoardTests {
    ...
    private static @NotNull Stream<Arguments> provideWrongBoardInSize() {
        return Stream.of(
                Arguments.of(2, 3, InvalidSizeOfBoard.class),
                Arguments.of(4, 3, InvalidSizeOfBoard.class),
                Arguments.of(11, 11, InvalidSizeOfBoard.class),
                Arguments.of(8, 3, InvalidSizeOfBoard.class),
                Arguments.of(45, 10, InvalidSizeOfBoard.class),
                Arguments.of(12, 12, InvalidSizeOfBoard.class),
